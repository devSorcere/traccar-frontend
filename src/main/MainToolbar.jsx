...
const MainToolbar = ({
  ...
  return (
    <Toolbar ref={toolbarRef} className={classes.toolbar}>
      {user?.attributes?.userImage ?
        (Device && <img src={`/api/media/user/${user?.id}/${user?.attributes?.userImage}`} alt="" className="position-fixed" style={{ width: "100px", height: "100px", position: "fixed", top: "12px", left: "441px" }} />) : (Device && <Avatar variant="square" style={{ width: "50px", height: "50px", position: "fixed", top: "12px", left: "441px" }} sx={{ width: "50px", height: "50px" }} />)}
      ...
      <Popover
        ...
        PaperProps={{
          style: {
            width: `calc(${toolbarRef.current?.clientWidth}px - ${theme.spacing(
              4
            )})`,
          },
        }}
