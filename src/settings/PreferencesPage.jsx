...
const PreferencesPage = () => {
  ...
  const [tokenExpiration, setTokenExpiration] = useState(
    moment().add(1, "week").locale("en").format(moment.HTML5_FMT.DATETIME_LOCAL)
  );
  const protocol = `${window.location.protocol}//${window.location.host}/?token=`;
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography
                  ...
                  sx={{ display: "flex", justifyContent: "center" }}
                >
                  <DevicesOtherIcon sx={{ marginRight: 1 }} />
                  {t("deviceTitle")}
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.details}>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography
                  ...
                  sx={{ display: "flex", justifyContent: "center" }}
                >
                  <AudiotrackIcon sx={{ marginRight: 1 }} />
                  {t("sharedSound")}
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.details}>
