...
import { MakePdf } from "./components/MakeStripPdf";
const columnsArray = [
...
const TripReportPage = () => {
  ...
  const handleSubmit = useCatch(async ({ deviceId, from, to, type }) => {
    ...
    if (type === "export") {
      ...
      MakePdf(t, t("reportTrips"), selectDevice, from, to, items, columns, new_columns, coordinateFormat, speedUnit, altitudeUnit, volumeUnit, distanceUnit, hours12, geofences, imgURL);
    }
    else {
      setLoading(true);
      try {
